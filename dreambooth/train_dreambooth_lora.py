...
def parse_args(disease, trial_number, black_or_brown, input_args=None):
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default=f"colab/DB/{disease}/SD_LORA/{black_or_brown}/dreambooth-model{trial_number}",
...
def main(disease, trial_number, args):
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        plt.savefig(f"colab/DB/{disease}/SD_LORA/loss_plot{trial_number}.png")  # Save the plot as a PNG file
